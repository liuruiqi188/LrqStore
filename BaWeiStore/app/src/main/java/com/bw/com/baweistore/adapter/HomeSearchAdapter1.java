...
/**
 * @author liuruiqi
 * @fileName HomeSearchAdapter1
 * @package com.bw.com.baweistore.adapter
 * @date 2019/3/21 11:25
 **/
public class HomeSearchAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    ShowData result;
    public HomeSearchAdapter1(Context context, ShowData result) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=LinearLayout.inflate(context, R.layout.homesearch_1,null);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        ShowDataaa showDataaa = result.getRxxp().getCommodityList().get(i);
